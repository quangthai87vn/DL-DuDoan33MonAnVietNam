...
import os
import numpy as np
from mobilenet_model import CustomMobileNet
# mobilenet_train_enrnptys.py
...
if __name__ == "__main__":
    ...
    # CẤU HÌNH MẶC ĐỊNH
    # ===============================
    train_dir = "C:/TRAIN/Deep Learning/vietnamese-foods/Images/Train"              # đường dẫn cố định đến thư mục ảnh
    num_epochs = 100                                                                # số lần huấn luyện
    batch_size = 32                                                                 # batch size
    model_path = "./models/mtl-mobilenet.pth"                                       # nơi lưu mô hình
